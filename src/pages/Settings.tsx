      ...
      <section className="data-surface p-5 sm:p-6">
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            className="btn-primary bg-info text-white border-info hover:bg-info/90 hover:border-info"
          >
            <Send className="w-4 h-4" />
            Open Bot
      ...
      <section className="data-surface p-5 sm:p-6">
        ...
        <div className="rounded-lg bg-bg-elevated p-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleCopy}
              className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-lg text-text-muted hover:bg-bg-hover hover:text-text-primary transition-colors"
            >
              {copied ? (
